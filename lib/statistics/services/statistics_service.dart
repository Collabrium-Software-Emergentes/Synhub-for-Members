...
class StatisticsService {
  ...
  Future<MemberStatistics> fetchMemberStatistics(String memberId) async {
    final overviewRes = await ApiClient.get('metrics/api/v1/metrics/member/$memberId/tasks/overview');
    final distributionRes = await ApiClient.get('metrics/api/v1/metrics/member/$memberId/tasks/distribution');
    final rescheduledRes = await ApiClient.get('metrics/api/v1/metrics/member/$memberId/tasks/rescheduled');
    final avgCompletionRes = await ApiClient.get('metrics/api/v1/metrics/member/$memberId/tasks/avg-completion-time');
